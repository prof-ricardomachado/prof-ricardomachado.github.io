...
},
{
  ...
  "body": " Limites Laterais   Limites Laterais    Escrevemos quando é possível se aproximar arbitrariamente de à medida que tende a por valores menores que . Similarmente, escrevemos quando é possível se aproximar arbitrariamente de à medida que tende a por valores maiores que .     Dada a função determine:       Nota-se no gráfico de (ver ) que quando tende a 2 pela esquerda . Portanto, o limite pela esquerda é               Nota-se no gráfico de (ver ) que quando tende a 2 pela direita . Portanto, o limite pela direita é        se somente se e .    Podemos reformular o escrevendo:  Existência de um Limite      Se qualquer um dos limites laterais não existir quando tende para , ou se ambos existem, mas são diferentes, então o limite quando tende para não existe.    Se o limite quando tende para não existe, então os limites são diferentes ou pelo menos um deles não existe.        Para determine:       Por definição, se , temos . Na observa-se que tende a quando tende a 1 pela esquerda. Portanto,               Por definição, se , temos . Na observa-se que tende a 0 quando tende a 1 pela direita. Portanto,      existe?   Os limites à esquerda e à direita de 1 são diferentes. Isso contraria regra de . Portanto, o limite de quando tende a 1 por ambos os lados não existe.      Seja . Encontre .    Observe que a formação de envolve módulo. Então, podemos transformar-lá em uma função definida em duas sentenças. Para isso, note que quando , daí . Por outro lado, quando , daí . Portanto, podemos escrever Dessa forma, quando , assume e quando , assume . Na observa-se que e que . Logo, segue do que             Limite de Função Composta   Sejam e duas funções tais que . Se e contínua em , então,     Calcule    Seja , para , então Como e é contínua em . Assim,      Calcule    Defina , logo com .  Quando , . Então,        Calcule o limite, se existir. Se o limite não existir, explique porquê.          Seja   Calcule e  Existe  Esboce o gráfico de    Seja   Calcule e  Existe  Esboce o gráfico de    Calcule         "
},
{
  "id": "def-laterais",
  "level": "2",
  ...
  "number": "2.2.1",
  "title": "",
  "body": "  Escrevemos quando é possível se aproximar arbitrariamente de à medida que tende a por valores menores que . Similarmente, escrevemos quando é possível se aproximar arbitrariamente de à medida que tende a por valores maiores que .   "
},
{
  "id": "ex-6",
  "level": "2",
  ...
  "number": "2.2.2",
  "title": "",
  "body": " Dada a função determine:       Nota-se no gráfico de (ver ) que quando tende a 2 pela esquerda . Portanto, o limite pela esquerda é               Nota-se no gráfico de (ver ) que quando tende a 2 pela direita . Portanto, o limite pela direita é    "
},
{
  "id": "thm-laterais",
  "level": "2",
