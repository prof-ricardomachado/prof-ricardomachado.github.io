...
},
{
  ...
  "number": "2.1.35",
  "title": "",
  "body": "(Rússia 2007) As faces de um cubo são particionadas em quadradinhos da forma usual. Sua superfície é coberta por 243 tiras de papel sem sobreposição. Uma tira é dita dobrada se está apenas sobre uma face. Prove que o número de tiras dobradas é ímpar.   A prova é construída em duas etapas lógicas. Primeiro, estabelecemos uma propriedade sobre cada face individual do cubo (argumento local). Em seguida, usamos esse resultado para chegar a uma conclusão sobre o cubo inteiro (argumento global).   Etapa 1: A Paridade das Saídas de uma Única Face     Seja o número de tiras dobradas que saem de uma face específica (ou seja, que têm um quadrado nessa face e o outro em uma face adjacente).    A área de qualquer face do cubo 9x9x9 é , um número ÍMPAR .    Essa área de 81 quadrados é coberta por tiras inteiramente contidas na face (planas) e por tiras que saem da face (dobradas). Isso nos dá a equação:     Analisando a paridade da equação, temos . A única forma de esta equação ser verdadeira é se , o número de tiras que saem de uma face, for ÍMPAR . Este resultado é válido para cada uma das 6 faces do cubo.     Etapa 2: A Soma de Todas as Saídas e a Conclusão     Seja o número total de tiras dobradas em todo o cubo.    Somamos o número de saídas de todas as 6 faces do cubo. Como sabemos da Etapa 1 que o número de saídas de cada face é ímpar, a soma total é:     Cada tira dobrada, por definição, conecta duas faces. Portanto, ao somar as saídas de todas as faces, contamos cada tira dobrada exatamente duas vezes: uma vez para cada face que ela toca.    Assim, a Soma Total das Saídas é exatamente o dobro do número total de tiras dobradas:     Juntando os resultados, temos a equação final:     Resolvendo para :     O produto de dois números ímpares (3 e o número de saídas de uma face) é necessariamente ÍMPAR . Assim, está provado que , o número total de tiras dobradas, é ímpar.   "
},
{
  "id": "problem-15",
  "level": "2",
