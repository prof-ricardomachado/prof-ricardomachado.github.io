...
},
{
  "id": "theorem-4",
  "level": "2",
  "url": "sec_introducao.html#theorem-4",
  "type": "Teorema",
  "number": "1.15",
  "title": "",
  "body": " Seja uma probabilidade sobre e sejam A e B eventos, então .  "
},
{
  "id": "example-4",
  "level": "2",
  "url": "sec_introducao.html#example-4",
  "type": "Exemplo",
  "number": "1.16",
  "title": "(OBM).",
...
},
{
  ...
  "number": "1.32",
  "title": "",
  "body": " (Veja e ) Quantos são os anagramas da palavra SAGAZ, na qual, nenhuma letra está em sua posição original?   Vamos contar o total de permutações e subtrair o número de permutações que possuem alguma letra na posição original. O total de permutações é A resposta será dada por Na qual, o conjunto é o conjunto das permutações com a letra na posição original.  Neste caso, vamos contar separadamente o número de permutações que tem alguma letra na posição original. Primeiro vamos contar 1 a 1, ou seja, fixamos a letra na posição original e calculamos o número de permutações das outras letras:  S:  A:  G:  A:  Z:  Assim,   Interseções 2 a 2, fixamos as letras nas posições originais e calculamos o número de permutações das outras letras:  SA:  SG:  SA:  SZ:  AG:  AA:  AZ:  GA:  GZ:  AZ:  Logo,   Interseções 3 a 3:  SAG:  SAA:  SAZ:  SGA:  SGZ:  SAZ:  AGA:  AGZ:  AAZ:  GAZ:  Logo,   Interseções 4 a 4:  AGAZ:  SGAZ:  SAAZ:  SAGZ:  SAGA:  Logo,   No caso 5 a 5, só temos uma maneira.   A resposta é        "
},
{
  "id": "example-11",
  "level": "2",
...
},
{
  "id": "technology-6",
  "level": "2",
  "url": "sec_introducao.html#technology-6",
  "type": "Tecnologia",
  "number": "1.37",
  "title": "",
...
{
  "id": "prob-urna-coincidencia",
  "level": "2",
  "url": "sec_introducao.html#prob-urna-coincidencia",
  "type": "Exercício",
  "number": "1.5.12",
  "title": "",
  "body": " Considere uma urna contendo bolas numeradas de a e assuma que as bolas são retiradas uma após a outra, sem reposição. Esta série de sorteios é encerrada com a ocorrência da primeira coincidência, ou seja, a bola número é sorteada na -ésima retirada. Calcule o número de séries de sorteios com uma duração dada de retiradas.   .  "
},
{
  "id": "ex-mesa-redonda",
  "level": "2",
  "url": "sec_introducao.html#ex-mesa-redonda",
  "type": "Exercício",
  "number": "1.5.13",
  "title": "",
...
{
  "id": "inclusao-exclusao-qrcode",
  "level": "2",
  "url": "section-2.html#inclusao-exclusao-qrcode",
  "type": "Figura",
  "number": "3.1",
  "title": "",
  "body": "  "
