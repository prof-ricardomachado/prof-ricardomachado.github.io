...
},
{
  ...
  "number": "2.1.5.5",
  "title": "",
  "body": " Mostre que um triângulo equilátero não pode ser totalmente coberto por outros dois triângulos equiláteros menores.   Pelo menos 1 vértice fica de fora.  "
},
{
  "id": "exercise-37",
  "level": "2",
...
},
{
  ...
  "number": "2.1.5.7",
  "title": "",
  "body": " (Bielorrússia 1996) Em um grupo de 29 hobbits existem alguns deles que falam a verdade e os outros que sempre mentem. Em um certo dia de primavera, todos eles se sentaram ao redor de uma mesa, e cada um deles falou que seus dois vizinhos eram mentirosos. a) Prove que pelo menos 10 hobbits falavam a verdade. b) É possível que exatamente 10 deles falem a verdade?   A configuração não pode ocorrer. Cada mentiroso tem pelo menos 1 vizinho verdadeiro.  a) Se forem no máximo 9 (V), serão pelo menos 20 (M). Haveria pelo menos uma sequência de três mentirosos seguidos ( ), o que é impossível pelas condições do problema.  b) Essa é a maneira que mais economiza V (com vizinhos ). Dessa maneira teríamos 10 V e 19 M, e não dá para colocar mais M. No total serão 29 hobbits.  "
},
{
  "id": "exercise-39",
  "level": "2",
  ...
  "number": "2.1.5.8",
  "title": "",
  "body": " Em cada casa de um tabuleiro 10x10 é posto um inteiro de modo que a diferença positiva entre os inteiros de duas casas vizinhas (lado em comum) é no máximo 5. Prove que dois destes inteiros devem ser iguais.   Seja o menor valor do tabuleiro. Para um vizinho o valor máximo é . A distância máxima entre os quadrados do tabuleiro é . Então, o valor máximo possível é . Temos de até possibilidades para os números, ou seja, 91 números possíveis e 100 quadrados. Pelo PCP, pelo menos dois números vão se repetir.  "
},
{
  "id": "exercise-40",
  "level": "2",
...
},
{
  ...
  "number": "2.1.5.11",
  "title": "",
  "body": " Prove que de qualquer subconjunto de elementos do conjunto é possível escolher dois que sejam primos entre si.   Observe que o MDC de dois números consecutivos é igual a 1: . Dos números consecutivos serão selecionados . As únicas maneiras de selecionar números sem selecionar consecutivos é selecionar todos os pares ou todos os ímpares. Ao selecionar o -ésimo elemento ele terá paridade diferente dos demais elementos e ficará entre dois números previamente selecionados. Logo, teremos 3 números consecutivos. Quaisquer 2 consecutivos, desses 3, serão primos entre si.  "
},
{
  "id": "exercise-43",
  "level": "2",
  ...
  "number": "2.1.5.12",
  "title": "",
  "body": " (IMO 1972) Prove que, de qualquer conjunto de dez números distintos de dois dígitos, podemos escolher dois subconjuntos A e B (disjuntos) cuja a soma dos elementos é a mesma em ambos.   A maior soma possível seria para o conjunto , que é 945. O conjunto com 10 elementos possui subconjuntos não vazios. Existem mais subconjuntos que valores possíveis para a soma dos elementos. Pelo PCP, pelo menos 2 subconjuntos possuem a mesma soma. Digamos e . Se , considere e . Então e as somas dos elementos continuarão iguais.  "
},
{
  "id": "exercise-44",
  "level": "2",
...
},
{
  "id": "exercise-47",
  "level": "2",
  "url": "section-7.html#exercise-47",
  "type": "Exercício",
  "number": "2.1.6.3",
  "title": "",
...
},
{
  "id": "exercise-48",
  "level": "2",
  "url": "section-7.html#exercise-48",
  "type": "Exercício",
  "number": "2.1.6.4",
  "title": "",
...
},
{
  "id": "exercise-49",
  "level": "2",
  "url": "section-7.html#exercise-49",
  "type": "Exercício",
  "number": "2.1.6.5",
  "title": "",
  "body": " É dado um conjunto de números inteiros ( ). Mostre que existem naturais e com , tais que é múltiplo de .  "
},
{
  "id": "section-8",
  "level": "1",
...
},
{
  ...
  "number": "2.2.3",
  "title": "",
  "body": "  (Belarus 2007 adaptado) Os pontos de um plano são pintados usando três cores. Prove que existe um triângulo isósceles monocromático.    Suponha que exista uma forma de pintar o plano de modo que não exista um triângulo isósceles monocromático. Assuma que as cores sejam verde, azul e vermelho. Construa um círculo e suponha, sem perda de generalidade, que o seu centro O seja verde. Dessa forma, pode haver no máximo um único ponto verde na circunferência, pois se houvesse dois, eles formariam com o centro um triângulo isósceles verde.  Assim, é possível construir um pentágono regular inscrito neste círculo cujos vértices são todos azuis ou vermelhos. Daí, pelo princípio da casa dos pombos, existirão pelo menos três vértices do pentágono que serão da mesma cor. Como quaisquer três vértices de um pentágono regular formam sempre um triângulo isósceles, existirá um triângulo isósceles monocromático, contrariando a suposição inicial.   "
},
{
  "id": "prob-3-diferenca",
  "level": "2",
...
},
{
  "id": "prob-4-cavalo",
  "level": "2",
  "url": "section-8.html#prob-4-cavalo",
  "type": "Exemplo",
  "number": "2.2.5",
  "title": "",
  "body": "  (Torneio das Cidades 1998) Em um tabuleiro , 17 casas são marcadas. Prove que é possível escolher duas dessas casas marcadas de modo que um cavalo de xadrez leve pelo menos três movimentos para ir de uma a outra.    Pinte as casas do tabuleiro usando 16 cores (numeradas de 1 a 16) conforme um padrão onde matrizes são repetidas ao longo do tabuleiro.     Justificativa formal da coloração: Para garantir o rigor na análise desta invariante, precisamos entender como a métrica do salto de cavalo opera no tabuleiro. O grafo de movimentos do cavalo é bipartido, o que significa que cada movimento sempre altera a cor da casa num padrão de xadrez tradicional (mudando a paridade da soma das coordenadas). Para retornar a uma casa da mesma cor no xadrez tradicional, o cavalo precisa de um número estritamente par de movimentos. Ao particionarmos o tabuleiro em 16 classes de equivalência (as cores de 1 a 16, com 4 casas cada), o padrão foi construído de modo que as casas de uma mesma classe possuem a mesma paridade de coordenadas, mas estão espaçadas a uma distância euclidiana que impede que sejam conectadas por caminhos de tamanho 2. Como não podem ser alcançadas em 2 movimentos, e a invariante de paridade exige um número par de saltos para conectar casas da mesma classe, a distância mínima no grafo do cavalo entre duas casas idênticas é de, pelo menos, 4 movimentos.  Observe que para se deslocar entre duas casas de mesma cor o cavalo necessita de pelo menos três movimentos (na verdade, provamos acima que são no mínimo 4). Portanto, pelo princípio da casa dos pombos, dentre 17 casas marcadas e 16 cores disponíveis, sempre haverá pelo menos duas da mesma cor, garantindo a condição exigida.   "
},
{
...
},
{
  "id": "exercise-63",
  "level": "2",
  "url": "section-8.html#exercise-63",
  "type": "Exercício",
  "number": "2.2.3.14",
  "title": "",
...
},
{
  "id": "exercise-64",
  "level": "2",
  "url": "section-8.html#exercise-64",
  "type": "Exercício",
  "number": "2.2.3.15",
  "title": "",
...
},
{
  "id": "exercise-65",
  "level": "2",
  "url": "section-8.html#exercise-65",
  "type": "Exercício",
  "number": "2.2.3.16",
  "title": "",
