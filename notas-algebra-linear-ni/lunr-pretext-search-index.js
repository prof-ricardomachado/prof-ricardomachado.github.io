...
},
{
  ...
  "number": "5.4",
  "title": "Exercícios",
  "body": " Exercícios    Seja uma função. Mostre que:   Se T é uma transformação linear, então .  Se então T não é uma transformação linear.     Determine quais das seguintes funções são aplicações lineares:                                Ache a transformação linear tal que , e .  Encontre v de tal que       Qual é a transformação linear tal que e ?  Ache e .  Qual é a transformação linear tal que , e ?  Ache a transformação linear tal que       Ache a transformação T do plano no plano que é uma reflexão em torno da reta .  Escreva-a em forma matricial.     No plano, uma rotação anti-horária de é seguida por uma dilatação de . Ache a aplicação A que representa esta transformação do plano.    Qual é a aplicação A que representa uma contração de seguida por uma rotação horária de     Dados linear e injetora e vetores LI em U, mostre que é LI.    Sejam R, S e T três transformações lineares de em .  Se   T tal que .    Sejam e bases de e respectivamente e    Ache T.  Se ache .  Ache uma base de tal que .     Se e , ache .    Se e ,   Ache .  Ache .     Seja o espaço vetorial de matrizes com base   Se é dada por    Ache onde é a base canônica de .  Se e . Ache S e, se for possível, tal que      Seja tal que . Ache os vetores u, v tal que        Mostre que se é uma transformação linear,   é um subespaço de W.  é um subespaço de V.     Sejam S e T aplicações lineares de V em W. Definimos como para todo e definimos como para todo e para todo .   Mostre que S+T é uma transformação linear de V em W.  Mostre que é uma transformação linear de V em W.  Mostre que é um espaço vetorial sobre R.  Suponha que dim e dim . Tente procurar dim X.      Considere a transformação linear    Determine uma base do núcleo de T.  Dê a dimensão da imagem de T.  T é sobrejetora? Justifique.  Faça um esboço de ker T e Im T.     Dê, quando possível, exemplos de transformações lineares T, S, L, M e H satisfazendo:   sobrejetora  com ker  , com Im  , com ker  com ker      Sejam e bases de e .   Dê a expressão para .    Seja   Encontre ker , Im , ker , Im , ker , Im . Determine bases para estes seis subespaços.    Seja uma reflexão, através da reta .   Encontre  Encontre a base de , tal que     Seja onde é a projeção do vetor v no plano .   Encontre .  Encontre uma base ordenada de , tal que      Seja onde L é a reflexão através do plano .   Encontre .  Encontre uma base ordenada de , tal que      Encontre a expressão da transformação linear que é uma rotação de em torno da reta que passa pela origem e tem a direção do vetor (1, 1, 0).    Um espelho plano está apoiado em uma parede vertical formando um ângulo de com ela. Se um feixe de luz de raios paralelos for emitido verticalmente (do teto para o chão) determine a direção dos raios refletidos.    "
},
{
  "id": "exercise-71",
  "level": "2",
  "url": "section-34.html#exercise-71",
  "type": "Exercício",
  "number": "5.4.1",
  "title": "",
  "body": " Seja uma função. Mostre que:   Se T é uma transformação linear, então .  Se então T não é uma transformação linear.   "
},
{
  "id": "exercise-72",
  "level": "2",
  "url": "section-34.html#exercise-72",
  "type": "Exercício",
  "number": "5.4.2",
  "title": "",
  "body": " Determine quais das seguintes funções são aplicações lineares:                            "
},
{
  "id": "exercise-73",
  "level": "2",
  "url": "section-34.html#exercise-73",
  "type": "Exercício",
  "number": "5.4.3",
  "title": "",
  "body": "   Ache a transformação linear tal que , e .  Encontre v de tal que   "
},
{
  "id": "exercise-74",
  "level": "2",
  "url": "section-34.html#exercise-74",
  "type": "Exercício",
  "number": "5.4.4",
  "title": "",
  "body": "   Qual é a transformação linear tal que e ?  Ache e .  Qual é a transformação linear tal que , e ?  Ache a transformação linear tal que   "
},
{
  "id": "exercise-75",
  "level": "2",
  "url": "section-34.html#exercise-75",
  "type": "Exercício",
  "number": "5.4.5",
  "title": "",
  "body": "   Ache a transformação T do plano no plano que é uma reflexão em torno da reta .  Escreva-a em forma matricial.   "
},
{
  "id": "exercise-76",
  "level": "2",
  "url": "section-34.html#exercise-76",
  "type": "Exercício",
  "number": "5.4.6",
  "title": "",
  "body": " No plano, uma rotação anti-horária de é seguida por uma dilatação de . Ache a aplicação A que representa esta transformação do plano.  "
},
{
  "id": "exercise-77",
  "level": "2",
  "url": "section-34.html#exercise-77",
  "type": "Exercício",
  "number": "5.4.7",
  "title": "",
  "body": " Qual é a aplicação A que representa uma contração de seguida por uma rotação horária de  "
},
{
  "id": "exercise-78",
  "level": "2",
  "url": "section-34.html#exercise-78",
  "type": "Exercício",
  "number": "5.4.8",
  "title": "",
  "body": " Dados linear e injetora e vetores LI em U, mostre que é LI.  "
},
{
  "id": "exercise-79",
  "level": "2",
  "url": "section-34.html#exercise-79",
  "type": "Exercício",
  "number": "5.4.9",
  "title": "",
  "body": " Sejam R, S e T três transformações lineares de em .  Se   T tal que .  "
},
{
  "id": "exercise-80",
  "level": "2",
  "url": "section-34.html#exercise-80",
  "type": "Exercício",
  "number": "5.4.10",
  "title": "",
  "body": " Sejam e bases de e respectivamente e    Ache T.  Se ache .  Ache uma base de tal que .   "
},
{
  "id": "exercise-81",
  "level": "2",
  "url": "section-34.html#exercise-81",
  "type": "Exercício",
  "number": "5.4.11",
  "title": "",
  "body": " Se e , ache .  "
},
{
  "id": "exercise-82",
  "level": "2",
  "url": "section-34.html#exercise-82",
  "type": "Exercício",
  "number": "5.4.12",
  "title": "",
  "body": " Se e ,   Ache .  Ache .   "
},
{
  "id": "exercise-83",
  "level": "2",
  "url": "section-34.html#exercise-83",
  "type": "Exercício",
  "number": "5.4.13",
  "title": "",
  "body": " Seja o espaço vetorial de matrizes com base   Se é dada por    Ache onde é a base canônica de .  Se e . Ache S e, se for possível, tal que    "
},
{
  "id": "exercise-84",
  "level": "2",
  "url": "section-34.html#exercise-84",
  "type": "Exercício",
  "number": "5.4.14",
  "title": "",
  "body": " Seja tal que . Ache os vetores u, v tal que      "
},
{
  "id": "exercise-85",
  "level": "2",
  "url": "section-34.html#exercise-85",
  "type": "Exercício",
  "number": "5.4.15",
  "title": "",
  "body": " Mostre que se é uma transformação linear,   é um subespaço de W.  é um subespaço de V.   "
},
{
  "id": "exercise-86",
  "level": "2",
  "url": "section-34.html#exercise-86",
  "type": "Exercício",
  "number": "5.4.16",
  "title": "",
  "body": " Sejam S e T aplicações lineares de V em W. Definimos como para todo e definimos como para todo e para todo .   Mostre que S+T é uma transformação linear de V em W.  Mostre que é uma transformação linear de V em W.  Mostre que é um espaço vetorial sobre R.  Suponha que dim e dim . Tente procurar dim X.   "
},
{
  "id": "exercise-87",
  "level": "2",
  "url": "section-34.html#exercise-87",
  "type": "Exercício",
  "number": "5.4.17",
  "title": "",
  "body": " Considere a transformação linear    Determine uma base do núcleo de T.  Dê a dimensão da imagem de T.  T é sobrejetora? Justifique.  Faça um esboço de ker T e Im T.   "
},
{
  "id": "exercise-88",
  "level": "2",
  "url": "section-34.html#exercise-88",
  "type": "Exercício",
  "number": "5.4.18",
  "title": "",
  "body": " Dê, quando possível, exemplos de transformações lineares T, S, L, M e H satisfazendo:   sobrejetora  com ker  , com Im  , com ker  com ker   "
},
{
  "id": "exercise-89",
  "level": "2",
  "url": "section-34.html#exercise-89",
  "type": "Exercício",
  "number": "5.4.19",
  "title": "",
  "body": " Sejam e bases de e .   Dê a expressão para .  "
},
{
  "id": "exercise-90",
  "level": "2",
  "url": "section-34.html#exercise-90",
  "type": "Exercício",
  "number": "5.4.20",
  "title": "",
  "body": " Seja   Encontre ker , Im , ker , Im , ker , Im . Determine bases para estes seis subespaços.  "
},
{
  "id": "exercise-91",
  "level": "2",
  "url": "section-34.html#exercise-91",
  "type": "Exercício",
  "number": "5.4.21",
  "title": "",
  "body": " Seja uma reflexão, através da reta .   Encontre  Encontre a base de , tal que   "
},
{
  "id": "exercise-92",
  "level": "2",
  "url": "section-34.html#exercise-92",
  "type": "Exercício",
  "number": "5.4.22",
  "title": "",
  "body": " Seja onde é a projeção do vetor v no plano .   Encontre .  Encontre uma base ordenada de , tal que    "
},
{
  "id": "exercise-93",
  "level": "2",
  "url": "section-34.html#exercise-93",
  "type": "Exercício",
  "number": "5.4.23",
  "title": "",
  "body": " Seja onde L é a reflexão através do plano .   Encontre .  Encontre uma base ordenada de , tal que    "
},
{
  "id": "exercise-94",
  "level": "2",
  "url": "section-34.html#exercise-94",
  "type": "Exercício",
  "number": "5.4.24",
  "title": "",
  "body": " Encontre a expressão da transformação linear que é uma rotação de em torno da reta que passa pela origem e tem a direção do vetor (1, 1, 0).  "
},
{
  "id": "exercise-95",
  "level": "2",
  "url": "section-34.html#exercise-95",
  "type": "Exercício",
  "number": "5.4.25",
  "title": "",
  "body": " Um espelho plano está apoiado em uma parede vertical formando um ângulo de com ela. Se um feixe de luz de raios paralelos for emitido verticalmente (do teto para o chão) determine a direção dos raios refletidos.  "
},
{
  "id": "section-35",
  "level": "1",
...
},
{
  "id": "theorem-22",
  "level": "2",
  "url": "section-35.html#theorem-22",
  "type": "Teorema",
  "number": "6.1.7",
...
},
{
  ...
  "number": "6.3",
  "title": "Exercícios",
  "body": " Exercícios    Seja    Mostre que é um autovalor de T e vetores da forma (x, 2x) são os autovetores correspondentes.    Ache os autovalores e autovetores correspondentes das transformações lineares dadas:   tal que  tal que  tal que  tal que  tal que (Isto é, T é a transformação que leva uma matriz na sua transposta.)  tal que  Encontre a transformação linear , tal que T tenha autovalores e associados aos autovetores e respectivamente.     Ache os autovalores e autovetores correspondentes das matrizes:                Seja   Quais são os autovalores e autovetores de A de um espaço vetorial:   Real  Complexo     Se é autovalor da transformação linear e é autovetor associado a ele, mostre que   é outro autovetor associado a se  O conjunto formado pelos autovetores associados a e o vetor nulo é subespaço de V.    Suponha que e sejam autovalores distintos e diferentes de zero de . Mostre que  Os autovetores e correspondentes são LI.  e são LI.     Seja    Ache os autovalores de A e de  Quais são os autovetores correspondentes?     Suponha que seja autovalor de com autovetor v e um número não nulo. Ache os autovalores e autovetores de .    Suponha que seja autovetor de e , ao mesmo tempo com autovalores e respectivamente. Ache autovetores e autovalores de        Seja linear   Se é autovalor de T, mostre que T não é injetora.  A recíproca é verdadeira? Ou seja, se T não é injetora, é autovalor de T?     Sejam   matrizes inversíveis.   Calcule AB e BA e observe que estes produtos são distintos.  Encontre os autovalores de AB e os de BA. O que você observa?  Encontre os autovetores de AB e os de BA. O que você nota?  Motivado pelos itens anteriores, mostre que: se A e B são matrizes inversíveis de mesma ordem, os autovalores de AB e BA são os mesmos. Mostre mais ainda: se é um autovalor de AB com autovetor v, então é autovalor de BA com autovetor Bv. Da mesma forma, se é um autovalor de BA com autovetor w, então é autovalor de AB com autovetor Aw.     "
},
{
  "id": "exercise-96",
  "level": "2",
  "url": "section-37.html#exercise-96",
  "type": "Exercício",
  "number": "6.3.1",
  "title": "",
  "body": " Seja    Mostre que é um autovalor de T e vetores da forma (x, 2x) são os autovetores correspondentes.  "
},
{
  "id": "exercise-97",
  "level": "2",
  "url": "section-37.html#exercise-97",
  "type": "Exercício",
  "number": "6.3.2",
  "title": "",
  "body": " Ache os autovalores e autovetores correspondentes das transformações lineares dadas:   tal que  tal que  tal que  tal que  tal que (Isto é, T é a transformação que leva uma matriz na sua transposta.)  tal que  Encontre a transformação linear , tal que T tenha autovalores e associados aos autovetores e respectivamente.   "
},
{
  "id": "exercise-98",
  "level": "2",
  "url": "section-37.html#exercise-98",
  "type": "Exercício",
  "number": "6.3.3",
  "title": "",
  "body": " Ache os autovalores e autovetores correspondentes das matrizes:              "
},
{
  "id": "exercise-99",
  "level": "2",
  "url": "section-37.html#exercise-99",
  "type": "Exercício",
  "number": "6.3.4",
  "title": "",
  "body": " Seja   Quais são os autovalores e autovetores de A de um espaço vetorial:   Real  Complexo   "
},
{
  "id": "exercise-100",
  "level": "2",
  "url": "section-37.html#exercise-100",
  "type": "Exercício",
  "number": "6.3.5",
  "title": "",
  "body": " Se é autovalor da transformação linear e é autovetor associado a ele, mostre que   é outro autovetor associado a se  O conjunto formado pelos autovetores associados a e o vetor nulo é subespaço de V.   "
},
{
  "id": "exercise-101",
  "level": "2",
  "url": "section-37.html#exercise-101",
  "type": "Exercício",
  "number": "6.3.6",
  "title": "",
  "body": "Suponha que e sejam autovalores distintos e diferentes de zero de . Mostre que  Os autovetores e correspondentes são LI.  e são LI.   "
},
{
  "id": "exercise-102",
  "level": "2",
  "url": "section-37.html#exercise-102",
  "type": "Exercício",
  "number": "6.3.7",
  "title": "",
  "body": " Seja    Ache os autovalores de A e de  Quais são os autovetores correspondentes?   "
},
{
  "id": "exercise-103",
  "level": "2",
  "url": "section-37.html#exercise-103",
  "type": "Exercício",
  "number": "6.3.8",
  "title": "",
  "body": " Suponha que seja autovalor de com autovetor v e um número não nulo. Ache os autovalores e autovetores de .  "
},
{
  "id": "exercise-104",
  "level": "2",
  "url": "section-37.html#exercise-104",
  "type": "Exercício",
  "number": "6.3.9",
  "title": "",
  "body": " Suponha que seja autovetor de e , ao mesmo tempo com autovalores e respectivamente. Ache autovetores e autovalores de      "
},
{
  "id": "exercise-105",
  "level": "2",
  "url": "section-37.html#exercise-105",
  "type": "Exercício",
  "number": "6.3.10",
  "title": "",
  "body": " Seja linear   Se é autovalor de T, mostre que T não é injetora.  A recíproca é verdadeira? Ou seja, se T não é injetora, é autovalor de T?   "
},
{
  "id": "exercise-106",
  "level": "2",
  "url": "section-37.html#exercise-106",
  "type": "Exercício",
  "number": "6.3.11",
  "title": "",
  "body": " Sejam   matrizes inversíveis.   Calcule AB e BA e observe que estes produtos são distintos.  Encontre os autovalores de AB e os de BA. O que você observa?  Encontre os autovetores de AB e os de BA. O que você nota?  Motivado pelos itens anteriores, mostre que: se A e B são matrizes inversíveis de mesma ordem, os autovalores de AB e BA são os mesmos. Mostre mais ainda: se é um autovalor de AB com autovetor v, então é autovalor de BA com autovetor Bv. Da mesma forma, se é um autovalor de BA com autovetor w, então é autovalor de AB com autovetor Aw.   "
},
{
  "id": "section-38",
  "level": "1",
...
},
{
  "id": "theorem-24",
  "level": "2",
  "url": "section-38.html#theorem-24",
  "type": "Teorema",
  "number": "6.4.2",
  "title": "",
...
},
{
  "id": "definition-45",
  "level": "2",
  "url": "section-38.html#definition-45",
  "type": "Definição",
  "number": "6.4.4",
...
},
{
  "id": "example-76",
  "level": "2",
  "url": "section-38.html#example-76",
  "type": "Exemplo",
  "number": "6.4.6",
  "title": "",
...
},
{
  "id": "example-77",
  "level": "2",
  "url": "section-39.html#example-77",
  "type": "Exemplo",
  "number": "6.5.4",
  "title": "",
...
},
{
  "id": "theorem-27",
  "level": "2",
  "url": "section-39.html#theorem-27",
  "type": "Teorema",
  "number": "6.5.5",
  "title": "",
...
},
{
  "id": "example-78",
  "level": "2",
  "url": "section-39.html#example-78",
  "type": "Exemplo",
  "number": "6.5.6",
  "title": "",
