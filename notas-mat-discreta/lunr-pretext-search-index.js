...
},
{
  ...
  "number": "3.1.26",
  "title": "",
  "body": " Calcule    Pelo , a sequência definida por é uma progressão aritmética de ordem , já que seu termo geral é um polinômio de grau 2. Logo, a soma de seus primeiros termos define uma progressão aritmética de ordem . Portanto, usando agora a volta do , o termo geral de é dado por um polinômios de grau 3 em . Isto é, podemos escrever . Atribuindo valores 1, 2, 3 e 4, obtemos as equações Resolvendo, encontramos Então,   Abaixo, usamos o SageMath para obter a solução do sistema.    "
},
{
  "id": "example-26",
  "level": "2",
