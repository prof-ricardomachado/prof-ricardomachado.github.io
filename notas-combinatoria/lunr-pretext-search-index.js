...
},
{
  ...
  "number": "2.6.4.3",
  "title": "",
  "body": "Refaça o princípio da reflexão no caso em que os caminhos não possam nem tocar a diagonal .  Quantidade total de caminhos. A quantidade de caminhos da origem até o ponto é   Quantidade de caminhos ruins. Observe que a reflexão será em relação a reta , portanto . Se contarmos os caminhos a partir da origem, todo caminho seria ruim, pois pertence a reta . Assim, estamos interessados em contar o total de caminhos ruins do ponto até o ponto . Logo, o número de caminhos ruins é    Exemplo de caminho ruim e sua reflexão, partindo do ponto .     Quantidade de caminhos bons. Neste caso, temos uma diferença em relação ao problema original. A quantidade de caminhos bons será igual a quantidade total de caminhos que partem do ponto menos a quantidade de caminhos ruins que também partem do ponto . Portanto, a quantidade de caminhos bons é   "
},
{
  "id": "ex-troco",
  "level": "2",
